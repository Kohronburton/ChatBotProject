...
const checks=[
  ['disclosure',html.includes('Independent concept demo')],['legal limit',html.includes('Not legal advice')],['wizard',html.includes('id="willForm"')],['five panels',(html.match(/data-step=/g)||[]).length===5],['conditional spouse',html.includes('id="spouseWrap"')],['conditional children',html.includes('id="childrenWrap"')],['required fields',html.includes('name="executor" required')],['review',js.includes('function buildReview')],['local save',js.includes('localStorage')],['simulated payment',html.includes('Simulate secure payment')],['pdf',js.includes("application/pdf")],['chat',html.includes('id="chatForm"')],['bounded answers',js.includes('qualified attorney')],['WebMCP',js.includes('start_will_demo')],['mobile',css.includes('@media(max-width:500px)')],['reduced motion',css.includes('prefers-reduced-motion')],['focus',css.includes(':focus-visible')],['no external assets',!html.includes('http')],['no contact info',!/@|mailto:|tel:/.test(html)],['no real card capture',!/(card number|cvv|cvc)/i.test(html)]];
